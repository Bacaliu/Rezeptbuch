...
\begin{document}
	...
	\chapter{Kuchen}
	\ohead*{Kuchen}
	\begin{srecipe}{Fantawaffeln}{4 Portionen}{15 Minuten}
		\ing[300]{g}{Mehl}
		\ing[150]{g}{Zucker}
	...
	\end{srecipe}
	\begin{srecipe}{Fantakuchen mit Schmand und Früchten}{Backblech}{1 Stunde}
		\ing[5]{}{Eier}
		\ing[300]{g}{Zucker}
		\ing[1]{Pkg.}{Vanillezucker}
	...
	\end{srecipe}
	\begin{srecipe}{Lebkuchenteig zum ausstechen}{1 Portion}{ein paar Minuten}
		\ing[600]{g}{Honig}
	...
	\end{srecipe}
	\begin{srecipe}{American Brownies}{1 Blech}{40 Minuten}
	...
	\chapter{Brot}
	\ohead*{Brot}
	\begin{srecipe}{Bananenbrot}{400g/1 Brot}{45 Minuten}
		Den Backofen auf 180\0C vorheizen.
	...
	\chapter{Kochen}
	\ohead*{Kochen}
	\begin{srecipe}{Schilli-Con-Carne}{4 Personen}{45 Minuten}
		\ing[2]{Tassen}{Reis}
		\ing[4]{Tassen}{Wasser}
		\ing[1]{Tl}{Salz}
	...
	\end{srecipe}
	\begin{srecipe}{Cartoffelcurry mit grünen Bohnen}{4 Portionen}{45 Minuten}
		\ing[1]{Kg}{Kartoffeln}
	...
	\end{srecipe}
	\begin{srecipe}{Burritos}{4 Portionen}{1 \fr{1}{4} Stunde}
		\ing[1]{TL}{Salz}
		\ing[1]{TL}{Kreuzkümmel}
	...
	\end{srecipe}
	\begin{srecipe}{Zucchini - Gnocchi - Auflauf}{4 Portionen}{1 Stunde}
		\ing[4]{}{Tomaten}
		\ing[2]{}{Zucchini}
		\ing[2]{}{Zwiebeln}
